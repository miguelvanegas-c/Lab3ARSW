...
class BlueprintsServicesTest {
    ...
    void testAddNewBlueprint_Success() throws BlueprintPersistenceException {
        ...
        BlueprintDTO blueprintDTO = new BlueprintDTO("john", "house", List.of());
        blueprint.setId(1L);
        when(blueprintMapper.toEntity(blueprintDTO)).thenReturn(blueprint);
    ...
    void testAddPoint_Success() throws BlueprintNotFoundException, BlueprintPersistenceException {
        ...
        when(pointMapper.toEntity(pointDTO)).thenReturn(point);
